...
function calculate() {
  ...
  let attrVal = `p2calcwire.html?pturns=${priN}&sturns=${secN}&leg=${w}&unit=${unit}&thick=${t}`;
...
function initp2() {
  ...
  qobj.perimS = 2 * (7 / 4 * qobj.leg) + 2 * qobj.thick;
...
//  estimated perimeter1 = 2*(11/8*leg + stack width) 
//  estimated perimeter2 = 2*(7/4*leg + stack width))
//  calculation of total resistance
//  calculation of voltage drops
//  calculation of estimated weight of wire
...
function simulate() {
  ...
  kgsP = toMeter(qobj.lengthP) / meterPerKg(awgPrimary);
  kgsS = toMeter(qobj.lengthS) / meterPerKg(awgSecondary);
  document.getElementById("kgsP").value = kgsP.toFixed(3);
  document.getElementById("kgsS").value = kgsS.toFixed(3);
}
...
function toMeter(length) {
  // convert to meter
  if (qobj.unit == "mm") return length/1000;
  if (qobj.unit == "cm") return length/100;
  if (qobj.unit == "in") return length*2.54/100;
  return NaN;
}
function toMil(dia) {
  // convert to inch
...
const freq  = 7; // frequency
const weight= 8; // weight m/kg
const Bforce= 9; // breaking force

function ampacity(awg) {
  return table(awg, Ach);
}

function meterPerKg(awg) {
  return table(awg, weight);
}

function table(awg, col) {
  let tab = {
    "AWG" :"Din       Dmm       Amm2      Rpkft   Rpkm      Ach   Apt     freq      weight Bforce",
    "-3"  :"0.4600 ,	11.68400, 107.000, 	0.0490, 0.16072 ,	380 ,	302 	, 125 Hz 	, NaN,  6120 lbs",
    "-2"  :"0.4096 ,	10.40384, 84.9000, 	0.0618, 0.202704, 328 ,	239 	, 160 Hz 	, NaN,  4860 lbs",
    "-1"  :"0.3648 ,	9.26592 ,	67.4000, 	0.0779, 0.255512, 283 ,	190 	, 200 Hz 	, NaN,  3860 lbs",
    "0"   :"0.3249 ,	8.25246 ,	53.5000, 	0.0983, 0.322424, 245 ,	150 	, 250 Hz 	, NaN,  3060 lbs",
    "1"   :"0.2893 ,	7.34822 ,	42.4000, 	0.1239, 0.406392, 211 ,	119 	, 325 Hz 	, 2.67, 2430 lbs",
    "2"   :"0.2576 ,	6.54304 ,	33.6000, 	0.1563, 0.512664, 181 ,	94 	  , 410 Hz 	, 3.37, 1930 lbs",
    "3"   :"0.2294 ,	5.82676 ,	26.7000, 	0.1970, 0.64616 ,	158 ,	75 	  , 500 Hz 	, 4.25, 1530 lbs",
    "4"   :"0.2043 ,	5.18922 ,	21.1000, 	0.2485, 0.81508 ,	135 ,	60 	  , 650 Hz 	, 5.36, 1210 lbs",
    "5"   :"0.1819 ,	4.62026 ,	16.8000, 	0.3133, 1.027624, 118 ,	47 	  , 810 Hz 	, 6.76, 960 lbs",
    "6"   :"0.1620 ,	4.11480 ,	13.3000, 	0.3951, 1.295928, 101 ,	37 	  , 1100 Hz , 8.53,	760 lbs",
    "7"   :"0.1443 ,	3.66522 ,	10.6000, 	0.4982, 1.634096, 89  ,	30 	  , 1300 Hz , 10.8,	605 lbs",
    "8"   :"0.1285 ,	3.26390 ,	8.37000, 	0.6282, 2.060496, 73  ,	24 	  , 1650 Hz , 13.5,	480 lbs",
    "9"   :"0.1144 ,	2.90576 ,	6.63000, 	0.7921, 2.598088, 64  ,	19 	  , 2050 Hz , 17.1,	380 lbs",
    "10"  :"0.1019 ,	2.58826 ,	5.26000, 	0.9989, 3.276392, 55  ,	15 	  , 2600 Hz , 21.5,	314 lbs",
    "11"  :"0.0907 ,	2.30378 ,	4.17000, 	1.260 ,	4.13280 ,	47  ,	12 	  , 3200 Hz , 27.1,	249 lbs",
    "12"  :"0.0808 ,	2.05232 ,	3.31000, 	1.588 ,	5.20864 ,	41  ,	9.3 	, 4150 Hz ,	34.2,	197 lbs",
    "13"  :"0.0720 ,	1.82880 ,	2.63000, 	2.003 ,	6.56984 ,	35  ,	7.4 	, 5300 Hz ,	43.2,	150 lbs",
    "14"  :"0.0641 ,	1.62814 ,	2.08000, 	2.525 ,	8.28200 ,	32  ,	5.9 	, 6700 Hz ,	54.5,	119 lbs",
    "15"  :"0.0571 ,	1.45034 ,	1.65000, 	3.184 ,	10.44352, 28  ,	4.7 	, 8250 Hz ,	68.7,	94 lbs",
    "16"  :"0.0508 ,	1.29032 ,	1.31000, 	4.016 ,	13.17248, 22  ,	3.7 	, 11 k Hz ,	86.6,	75 lbs",
    "17"  :"0.0453 ,	1.15062 ,	1.04000, 	5.064 ,	16.60992, 19  ,	2.9 	, 13 k Hz ,	109,  59 lbs",
    "18"  :"0.0403 ,	1.02362 ,	0.82300, 	6.385 ,	20.9428 ,	16  ,	2.3 	, 17 kHz 	, 137,  47 lbs",
    "19"  :"0.0359 ,	0.91186 ,	0.65300, 	8.051 ,	26.40728, 14  ,	1.8 	, 21 kHz 	, 173,  37 lbs",
    "20"  :"0.0320 ,	0.81280 ,	0.51900, 	10.15 ,	33.2920 ,	11  ,	1.5 	, 27 kHz 	, 218,  29 lbs",
    "21"  :"0.0285 ,	0.72390 ,	0.41200, 	12.80 ,	41.9840 ,	9  	, 1.2 	, 33 kHz 	, 275,  23 lbs",
    "22"  :"0.0253 ,	0.64516 ,	0.32700, 	16.14 ,	52.9392 ,	7  	, 0.92 	, 42 kHz 	, 348,  18 lbs",
    "23"  :"0.0226 ,	0.57404 ,	0.25900, 	20.36 ,	66.7808 ,	4.7 ,	0.729 ,	53 kHz 	, 439,  14.5 lbs",
    "24"  :"0.0201 ,	0.51054 ,	0.20500, 	25.67 ,	84.1976 ,	3.5 ,	0.577 ,	68 kHz 	, 553,  11.5 lbs",
    "25"  :"0.0179 ,	0.45466 ,	0.16200, 	32.37 ,	106.1736, 2.7 ,	0.457 ,	85 kHz 	, 698,  9 lbs",
    "26"  :"0.0159 ,	0.40386 ,	0.12800, 	40.81 ,	133.8568, 2.2 ,	0.361 ,	107 kHz , 881, 	7.2 lbs",
    "27"  :"0.0142 ,	0.36068 ,	0.10200, 	51.47 ,	168.8216, 1.7 ,	0.288 ,	130 kHz ,1110,	5.5 lbs",
    "28"  :"0.0126 ,	0.32004 ,	0.08000, 	64.90 ,	212.872 ,	1.4 ,	0.226 ,	170 kHz ,1400,	4.5 lbs",
    "29"  :"0.0113 ,	0.28702 ,	0.06470, 	81.83 ,	268.4024, 1.2 ,	0.182 ,	210 kHz ,1766,	3.6 lbs",
    "30"  :"0.0100 ,	0.25400 ,	0.05070, 	103.2 ,	338.496 ,	0.86, 0.142 ,	270 kHz ,2227,	2.75 lbs",
    "31"  :"0.0089 ,	0.22606 ,	0.04010, 	130.1 ,	426.728 ,	0.7 ,	0.113 ,	340 kHz ,2809,	2.25 lbs",
    "32"  :"0.0080 ,	0.20320 ,	0.03240, 	164.1 ,	538.248 ,	0.53, 0.091 ,	430 kHz ,3542,	1.8 lbs",
    "33"  :"0.0071 ,	0.18034 ,	0.02550, 	206.9 ,	678.632 ,	0.43, 0.072 ,	540 kHz ,4467,	1.3 lbs",
    "34"  :"0.0063 ,	0.16002 ,	0.02010, 	260.9 ,	855.752 ,	0.33, 0.056 ,	690 kHz ,5632,	1.1 lbs",
    "35"  :"0.0056 ,	0.14224 ,	0.01590, 	329.0 ,	1079.12 ,	0.27, 0.044 ,	870 kHz ,7103,	0.92 lbs",
    "36"  :"0.0050 ,	0.12700 ,	0.01270, 	414.8 ,	1360.00 ,	0.21, 0.035 ,	1100 kHz,8953,	0.72 lbs",
    "37"  :"0.0045 ,	0.11430 ,	0.01030, 	523.1 ,	1715.00 ,	0.17, 0.0289, 1350 kHz,11200, 0.57 lbs",
    "38"  :"0.0040 ,	0.10160 ,	0.00811, 	659.6 ,	2163.00 ,	0.13, 0.0228, 1750 kHz,14200, 0.45 lbs",
    "39"  :"0.0035 ,	0.08890 ,	0.00621, 	831.8 ,	2728.00 ,	0.11, 0.0175, 2250 kHz,18000, 0.36 lbs",
    "40"  :"0.0031 ,	0.07874 ,	0.00487,   1049 , 3440.00 ,	0.09, 0.0137, 2900 kHz,22600, 0.29 lbs"
  };
